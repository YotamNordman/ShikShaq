        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<string>(maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAdmin = table.Column<string>(maxLength: 1, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInBranch", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInBranch_Branch_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductInBranch_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInBranch_BranchId",
                table: "ProductInBranch",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInBranch_ProductId",
                table: "ProductInBranch",
                column: "ProductId");
